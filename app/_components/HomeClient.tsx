  ...
  */
  ...
  return (
    <main className="flex-grow flex flex-col w-full max-w-[1280px] mx-auto px-4 md:px-6 pt-4 sm:pt-6 pb-12 gap-5 sm:gap-6">
      <h1 className="sr-only">Cricket 007 — Live Cricket Scores, Predictions & Mini-Games</h1>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <h2 className="font-headline m-0 text-xl sm:text-2xl font-bold tracking-tight text-white">
